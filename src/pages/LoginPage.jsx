...
export default function LoginPage() {
  ...
  const [showPass, setShowPass] = [false, () => {}]
  const [pressed, setPressed] = [false, () => {}]
  ...
  const togglePass = () => {
    ...
    eyeRef.current.textContent = inp.type === 'password' ? '👁' : '🙈'
  }
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <div className="input-wrap">
              ...
              <input type="text" placeholder="you@email.com" autoComplete="off" required/>
          ...
          <div className="form-group">
            ...
            <div className="input-wrap">
              <span className="input-icon">🔒</span>
              <input type="password" ref={passRef} placeholder="••••••••" required/>
              <button type="button" className="eye-btn" ref={eyeRef} onClick={togglePass}>👁</button>
              <div className="input-glow"/>
            </div>
          </div>
